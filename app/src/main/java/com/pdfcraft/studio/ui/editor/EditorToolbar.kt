...
fun EditorToolbar(
    ...
    onResizeImagesMenuClick: () -> Unit = {},
    resizeEditActive: Boolean = false,
    onResizeDone: () -> Unit = {},
    ...
    Column(
        ...
        when {
            ...
            resizeEditActive || shapeModeActive -> ImageShapeSlider(
            ...
            pageMarginModeActive -> PageMarginSlider(
                ...
                Row(
                    ...
                    ImageToolsMenu(
                        ...
                        onAdjustImageShapeClick = onResizeImagesMenuClick,
